...
const seed: Item[] = [
  ...
  },
  {
    id: "live-2",
    title: "Live #2",
    img: "https://images.unsplash.com/photo-1600855944280-818d239f5c25?auto=format&fit=crop&w=1200&q=80",
  },
  {
    id: "live-3",
    title: "Live #3",
    img: "https://images.unsplash.com/photo-1520973799238-8b1a043d2d9b?auto=format&fit=crop&w=1200&q=80",
  },
  {
    id: "live-4",
    title: "Live #4",
  ...
  useEffect(() => {
    ...
    const onScroll = () => {
      ...
      if (el.scrollLeft <= c * 0.5)
        el.scrollLeft += c; // left edge → jump forward
      ...
      <div className="w-full">
        ...
        >
          {items.map((item, idx) => (
            <div
              key={`${item.id}-${idx}`}
              className={`shrink-0 w-[220px] overflow-visible ${glowRed ? "thumb-glow" : ""}`}
            >
              <ThumbnailCard
                data={{
                  title: item.title,
