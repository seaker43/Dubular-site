...
const cards = [
  {
    title: "Top Streamers",
    img: "https://images.unsplash.com/photo-1600132806370-bf17e65e942f?q=80&w=1200",
  },
  {
      ...
      <div className="mx-auto grid max-w-5xl grid-cols-3 gap-4">
        {cards.map((c) => (
          <a
            key={c.title}
            href="#"
            className="group relative overflow-hidden rounded-2xl ring-1 ring-white/10 shadow-[0_0_0_2px_rgba(255,255,255,0.06)]"
          >
            ...
            <div className="pointer-events-none absolute inset-x-0 bottom-2 flex justify-center">
              <span className="rounded-md bg-black/55 px-2 py-1 text-sm font-medium text-white">
                {c.title}
              </span>
            </div>
          </a>
