...
export default function CategoryRow({ title, items = [] }) {
 ...
 <div
 className="pointer-events-none absolute inset-x-0 bottom-0 p-0
 ...
 {it.live && (
 <span className="ml-2 inline-flex items-center rounded-full py-0.5 text-[10px] font-semibold gold-glow bg-black/40">
 LIVE
 </span>
 )}
 </div>
