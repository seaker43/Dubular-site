"use client";
import { UserProfile, SignedIn, SignedOut, RedirectToSignIn, SignOutButton } from "@clerk/nextjs";
    ...
    <>
      <SignedIn>
        <div className='mx-auto w-full max-w-3xl px-4 pb-16 pt-6 text-white'>
          ...
          <UserProfile appearance={{ layout: { socialButtonsPlacement: 'bottom' }, variables: { colorBackground: 'rgb(10,10,10)', colorText: 'rgb(229,229,229)', colorInputBackground: 'rgb(23,23,23)', borderRadius: '16px' } }} routing='hash' />
