...
import { sqliteTable, integer as sInt, text as sText } from "drizzle-orm/sqlite-core";

export const users_pg = pgTable("users", {
...
export const users_sqlite = sqliteTable("users", {
  ...
  createdAt: sText("created_at").default(sql`CURRENT_TIMESTAMP`).notNull(),
});
